...
void MyTCPServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MyTCPServer::*)(const QString & , const QString & );
        ...
        {
            using _t = void (MyTCPServer::*)(const QString & , quint16 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTCPServer::myServerConnected)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTCPServer::myServerDisconnected)) {
                *result = 2;
                return;
            }
        }
